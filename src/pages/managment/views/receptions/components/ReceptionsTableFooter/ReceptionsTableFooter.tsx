...
const ReceptionsTableFooter: FunctionComponent<ReceptionsTableFooterProps> = ({
  apiRef,
}) => {
  ...
  console.log(apiRef.current.getSelectedRows()); // We will need this after connecting to the backend
  return (
